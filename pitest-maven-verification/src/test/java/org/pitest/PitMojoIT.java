...
public class PitMojoIT {
    ...
    public void shouldNotHangWhenLargeAmountsOfConsoleOutput() throws Exception {
        ...
        assertThat(readResults(testDir)).contains("<sourceFile>SomeCode.java</sourceFile>");
    }
   ...
   */
    ...
    private static String readResults(File testDir) throws IOException {
        File mutationReport = new File(testDir.getAbsoluteFile() + File.separator + "target" + File.separator + "pit-reports" + File.separator + "mutations.xml");
        return FileUtils.readFileToString(mutationReport);
    }

    private static String readCoverage(File testDir) throws IOException {
        File coverage = new File(testDir.getAbsoluteFile() + File.separator + "target" + File.separator + "pit-reports" + File.separator + "linecoverage.xml");
